...
<table  class="table table-sm table-striped">
	<thead>
	<tr id='head1'>
		<th style="font-family: Arial;background-color: #1192e8; color: white; font-size: 25px;text-align: center;padding: 4px;">Departure Count</th>
	</tr>
	</thead>
</table> 
...
<div class="row">
	...
	<table class="tableDesign">
		<tr style="font-size: 28px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
			<th colspan="3" style="text-align: center;background-color:#e72a5c;border-color: #e72a5c; text-align: center;">Departure&nbsp;Count</th>
		</tr>
		<tr style="font-size: 18px; font-family: 'Arial', serif;color: white; font-weight: bold; text-align: center;border-color: #1192e8;height:40px;">
			...
			<th style="text-align: left;background-color:#e93d6b;border-color: #A4133C;width:87%;">Departure&nbsp;Query</th>
...
////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy')";
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy') and pax_chk_date = to_date('" + queryDate_less + "','dd/mm/yyyy')" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy') and pax_chk_date = to_date('" + queryDate_plus + "','dd/mm/yyyy')" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy') and pax_chk_date = to_date('" + input_date_query_z + "','dd/mm/yyyy')" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////Second/////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_chk_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy')";
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_chk_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy') and pax_boarding_date = to_date('" + queryDate_less + "','dd/mm/yyyy')" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_chk_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy') and pax_boarding_date  = to_date('" + queryDate_plus + "','dd/mm/yyyy')" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_chk_date = to_date('"+ input_date_query_z +"','dd/mm/yyyy') and pax_boarding_date = to_date('" + input_date_query_z + "','dd/mm/yyyy')" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
////////////////////////////////////////////////////////////////////////
		try 
		{
				...
				//Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date >= to_date('" + input_date_query_z + "','dd/mm/yyyy') and pax_boarding_date <= to_date('" + input_date_query_z + "','dd/mm/yyyy') and  TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME >= '20240103000000' AND TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME <= '20240103235959'" ;
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date >= to_date('" + input_date_query_z + "','dd/mm/yyyy') and pax_boarding_date <= to_date('" + input_date_query_z + "','dd/mm/yyyy') and  TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME >= '" + input_date_query_YYYYMMDD_000000 + "' AND TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME <= '" + input_date_query_YYYYMMDD_235959 + "'" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
...
///////////////////////////////////////////////////////////////////////////
		try 
		{
				//Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date >= to_date('" + queryDate_less + "','dd/mm/yyyy') and pax_boarding_date <= to_date('" + queryDate_plus + "','dd/mm/yyyy') and  TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME >= '202401030000' AND TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME <= '202401032359'" ;
				Arr_Count_Query = "select count(1) as ccount from im_trans_dep_total@DBL_IVFRT004 where pax_boarding_date >= to_date('" + input_date_query_z + "','dd/mm/yyyy') and pax_boarding_date <= to_date('" + input_date_query_z + "','dd/mm/yyyy') and  TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME >= '"+ input_date_query_YYYYMMDD_0000 +"' AND TO_CHAR(PAX_CHK_DATE,'YYYYMMDD') || PAX_CHK_TIME <= '" + input_date_query_YYYYMMDD_2359 + "'" ;
				psTemp = con.prepareStatement(Arr_Count_Query);
				rsTemp = psTemp.executeQuery();
				while (rsTemp.next()) 
				{
